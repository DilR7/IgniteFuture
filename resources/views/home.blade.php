        ...
        <div class="grid grid-cols-10 text-black gap-4">
            <div class="flex flex-col text-start gap-4 col-span-4 pr-4">
                ...
                <div class="text-white flex gap-4 text-sm">
                    <button class="bg-dodger-blue-700 p-2 px-3 rounded-md">Join The Family</button>
                    <button class="bg-dodger-blue-700 p-2 px-3 rounded-md">Browse All Courses</button>
                </div>
            </div>
