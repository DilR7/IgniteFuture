<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-full bg-white border-r border-gray-200 transition-transform transform -translate-x-full sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
    <div class="h-full px-3 pb-4 overflow-y-auto mt-20">
        <ul class="space-y-2 font-medium">
            <li class="mb-4">
                <a href="#" class="flex items-center ms-2">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="Logo" />
                    <span class="self-center text-xl font-semibold dark:text-white">Ignite Future</span>
                </a>
            </li>
            <li>
                <a href="{{ route('dashboard') }}"
                    ...
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke="currentColor" stroke-linejoin="round" stroke-width="2"
                            d="M8 8v1h4V8m4 7H4a1 1 0 0 1-1-1V5h14v9a1 1 0 0 1-1 1ZM2 1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H2a1 1 0 1 1-1-1V2a1 1 0 0 1 1-1Z" />
                    </svg>
                    <span class="ms-3">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('adminmodule') }}"
            ...
            <li>
                <a href="{{ route('home') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="mr-2 flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
