            ...
            <tbody>
                @foreach ($adminbook as $book)
                    <tr
                        ...
                        <td class="px-2 py-2">
                            <iframe src="data:application/pdf;base64, {{ $book->content }}" width="300px" height="100px"
                                class="border rounded-md shadow-md">
                            </iframe>
                        </td>
                        <td class="px-2 py-2">
                            <img class="w-20 h-20 object-cover" src="data:image/png;base64, {{ $book->img }}"
                                alt="investment-seed-round" />
                        </td>
                        <td>
                            <a href="{{ route('adminbook.edit', $book->id) }}"
                            ...
                            <form action="{{ route('adminbook.delete', $book->id) }}" method="POST"
