...
@section('main-content')
    <div class="px-32 pb-16">
        ...
        <div class="grid grid-cols-8 text-black gap-6">
            ...
            <div class="flex flex-col text-center gap-4 col-span-2 pr-4">
                ...
                <div class="flex flex-col items-start border-2 border-blue-500 rounded-lg">
                    <div class="flex justify-center w-full p-4 text-bold">My Courses</div>

                    <div class="flex flex-col py-4 w-full gap-4">
                    ...
                    <div class="flex flex-col w-full py-4 px-4 border-x-2 text-xs gap-2 font-medium">
            ...
            <div class="flex flex-col text-center gap-4 col-span-2 pr-4">
                ...
                <div class="flex flex-col items-start border-2 border-blue-500 rounded-lg">
                    <div class="flex justify-center w-full p-4 border- text-bold">My Courses</div>
                    <div class="flex flex-col w-full py-4 px-4 border-x-2 text-xs gap-2 font-medium">
                        <div class="flex justify-between">
                            <div>Published Date</div>
                            <div class="text-gray-500">20 May 2020</div>
